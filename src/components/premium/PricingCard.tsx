...
export const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return (
    <motion.div
      ...
      onClick={onSelect}
      className={`relative flex flex-col justify-between rounded-2xl p-4 md:p-6 shadow-lg border transition-all duration-300 cursor-pointer
        ${highlighted
    ...
    >
      <div>
        ...
        <p className="text-xl md:text-2xl lg:text-4xl font-bold mb-2">{price}</p>
      ...
      <Button
        ...
        className={`mt-6 md:mt-8 w-full text-sm md:text-base
          ${highlighted
