  ...
  return (
    <div className="absolute top-full mt-2 w-full bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-lg shadow-lg z-20 max-h-96 overflow-y-auto">
      <div
        ...
        className="p-3 flex items-center space-x-3 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer"
      >
        <SearchIcon />
        <p>Ir para a busca de <span className="font-bold">"{query}"</span></p>
      </div>
        ...
        <>
          ...
          {filteredUsers.map(user => (
            <div
              ...
              className="flex items-center space-x-3 p-3 hover:bg-gray-200 dark:hover:bg-gray-700 cursor-pointer"
            >
