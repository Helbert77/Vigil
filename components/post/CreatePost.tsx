...
interface CreatePostProps {
  ...
  community?: Community; // New optional prop
  allUsers: User[];
}

const CreatePost: React.FC<CreatePostProps> = ({ onAddPost, user, communities, joinedCommunityIds, community, allUsers }) => {
  ...
  const isPostDisabled = (!text.trim() && !imageUrl && !videoUrl && !audioUrl && !mediaType) || isGenerating || isUploading;
