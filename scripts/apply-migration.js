...
if (!SUPABASE_SERVICE_KEY) {
  ...
  console.log('2. Definir a variável de ambiente: set SUPABASE_SERVICE_KEY=sua_chave_aqui');
...
console.log('🔧 Script de Aplicação de Migração - Tabela account_deletion_requests');
console.log('📋 Este script criará a tabela necessária para o sistema de exclusão de contas');
console.log('');
